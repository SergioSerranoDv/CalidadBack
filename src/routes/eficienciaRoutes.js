...
const EficienciaWango = require("../models/eficienciaModel")
const { registrar } = require("../controllers/eficienciaController")
...
router.get("/", async (req, res) => {
  try {
    const eficiencias = await EficienciaWango.find()
    res.json(eficiencias)
  } catch (error) {
